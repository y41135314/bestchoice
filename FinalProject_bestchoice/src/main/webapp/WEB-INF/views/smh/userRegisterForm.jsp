...
$(document).ready(function(){
	...
	// 이메일 정규식, 중복검사 		
		$("#email").blur(function(){
			...
			$.ajax({
				url: "${pageContext.request.contextPath}/userEmailCheck.bc",
				type: "GET",
				data:{
					"email":$('#email').val()
				},
				success: function(data){
					if(data == 0 && $.trim($('#email').val()) != '' ){
						...
						$("#error_email3").show(); /* 이메일 사용가능  */
						$("#error_email2").hide();
						$("#error_email").hide();

					}else{						
						$("#error_email2").show(); /* 중복된 이메일 입니다.  */
						$("#error_email3").hide(); /* 이메일 사용가능  */
						$('#email').empty();
						$('#email').focus();
        ...
        <div class="joinUser">
           ...
           <b class="register_title">이름</b>
            ...
            <b class="register_title">이메일 아이디
            	 ...
            	 <b class=smh_error id="error_email2">* 중복된 이메일 입니다.</b>
            	 <b class=smh_error id="error_email3">* 사용가능</b>
            ...
            <b class="register_title">비밀번호
            	<b class=smh_error id="error_pwd">* 영문자,숫자,특수기호가 혼합된 8~15 글자로만 입력해주세요.</b>
            </b> 
            <div class="inp_type_2 form-errors">
                <input class="regeisterInfo" type="password" name="pwd" id="pwd" placeholder="비밀번호를 입력해주세요."/>
            </div>
            ...
            <div class="inp_type_2 form-errors">
                <input  class="regeisterInfo" type="password" name="pwd_check" id="pwd_check" placeholder="비밀번호를 입력해주세요."  class="required"
			...
			<div class="inp_type_2" style="vertical-align: middle; ">

			    <select name="hp1" id="hp1" class="input_hp" style="margin-top: 13px; border-style: none;">
					<option value="010"  selected>010</option>
				</select>&nbsp;-&nbsp;
			    <input type="text" name="hp2" class="input_hp" id="hp2" size="6" maxlength="4" style="width:75px; vertical-align: top;"/>&nbsp;-&nbsp;
			    <input type="text" name="hp3" class="input_hp" id="hp3" size="6" maxlength="4" style="width:75px;  vertical-align: top;" />
            ...
            <div class="inp_type_2 form-errors"><!-- focus / err -->
                <input type="text" name="birthday" id="birthday" placeholder="ex)19940715" required data-msg-required="생년월일을 다시한번 체크해주세요."/>
            </div>
