...
<div id="adminWrite">
	...
	<input type="text" name="fk_sellerName" id="fk_sellerName" value="${boardvo.fk_sellerName}" autocomplete="off" style="font-size: 8pt; width: 7%; margin-bottom: 5px;" class="short"  /> 
	<input type="text" name="fk_hotelName" id="fk_hotelName" value="${boardvo.fk_hotelName}"autocomplete="off"  style="font-size: 8pt; width: 7%; margin-bottom: 5px;" class="short"  /> 
	<br/>
	...
	<div id="hotelDisplayList" style="width: 7%; font-size: 8pt; position: relative; left: 14.8%; min-height: 50px; margin-top: -374px;  border-top: none; border: solid 1px gray; background-color: white; z-index: 2 ">
	</div>   
</div>
